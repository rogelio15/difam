...
public class jdCalen extends javax.swing.JDialog {
    ...
    public jdCalen(java.awt.Frame parent, boolean modal, char modulo) {
        super(parent, modal);
        initComponents();
    ...
    public jdCalen(java.awt.Frame parent, boolean modal, char modulo,JTextField txt) {
        super(parent, modal);
        initComponents();
        this.txt = txt;
        paneBotones.setLayout(new GridLayout(7, 7, 4, 4));
